...
func (t *tableManagerImpl[T]) Delete(ctx context.Context, instance *T) error {
	return doWithTracing(ctx, t.Tracer, t.Spec.Name+"/DeleteByObject", t.TraceAttributes, func(ctx context.Context) error {
		return t.Table.
...
func (t *tableManagerImpl[T]) DeleteByPrimaryKey(ctx context.Context, keys ...interface{}) error {
	return doWithTracing(ctx, t.Tracer, t.Spec.Name+"/DeleteByPrimaryKey", t.TraceAttributes, func(ctx context.Context) error {
		return t.Table.
			DeleteQueryContext(ctx, t.Session).
			Consistency(t.writeConsistency).
			Bind(keys...).
