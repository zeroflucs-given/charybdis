...
func (t *tableManagerImpl[T]) Upsert(ctx context.Context, instance *T, opts ...UpdateOption) error {
	return doWithTracing(ctx, t.Tracer, t.Spec.Name+"/Upsert", t.TraceAttributes, func(ctx context.Context) error {
...
func (t *tableManagerImpl[T]) UpsertBulk(ctx context.Context, instances []*T, concurrency int, opts ...UpdateOption) error {
	...
	return doWithTracing(ctx, t.Tracer, t.Spec.Name+"/UpsertBulk", t.TraceAttributes, func(ctx context.Context) error {
